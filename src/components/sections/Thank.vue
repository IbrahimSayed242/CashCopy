<template>
  <div class="flex justify-center">
    <div
      class="content relative flex-wrap-reverse mt-20 bg-[url(https://res.cloudinary.com/dt9k74vof/image/upload/v1709982615/copy/stocks-bg_svid4a_dcpcpd.png)] bg-cover bg-no-repeat bg-center bg-[#11726dc7]"
    >
      <div class="info text-2xl m-20 md:m-15 text-center font-bold" dir="rtl">
        ...
        <h2 class="text-3xl font-bold text-teal-200" style="line-height: 1.5">
          ضاعف حجم استثماراتك دون تحمل المخاطر
        </h2>
        <p class="">اختر الكوبون الأنسب لك وانطلق في رحلة الثراء الآن</p>
...
.swiper-slide:nth-child(1n) {
  background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
    url(https://flagedu.com/media/images/1_1_zly7bak.original.png) no-repeat 50%
      50% / cover;
}

.swiper-slide:nth-child(2n) {
  background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
    url(https://flagedu.com/media/images/1_2.original.png) no-repeat 50% 50% /
      cover;
}

.swiper-slide:nth-child(3n) {
  background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
    url(https://flagedu.com/media/images/3_7WeQwvl.original.png) no-repeat 50%
      0% / cover;
}

.swiper-slide:nth-child(4n) {
  background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
    url(https://flagedu.com/media/images/4.original.png) no-repeat 50% 50% /
      cover;
}
